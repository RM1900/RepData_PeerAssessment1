...
From the activity data there are `r sum(is.na(activityData$steps))` missing values coded as NA.  As the missing values may bias some calculations or data, we are to:
